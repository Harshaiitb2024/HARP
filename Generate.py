...
def create_ambisonic_array(order_of_ambisonics, sample_rate):
  ...
  mic_positions, orientations, degrees = generate_hoa_array(

    samples=samples, radius=0.0001, n_order=order
...
if __name__ == "__main__":
  ...
  main("./Generated_HOA_IRs/", num_rooms=1, num_positions=2) # 500,20